# -*- encoding: utf-8 -*-
# stub: meta-tags 2.15.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<actionpack>.freeze, [">= 3.2.0", "< 6.2"])
    s.add_development_dependency(%q<railties>.freeze, [">= 3.2.0", "< 6.2"])
    ...
    s.add_dependency(%q<actionpack>.freeze, [">= 3.2.0", "< 6.2"])
    s.add_dependency(%q<railties>.freeze, [">= 3.2.0", "< 6.2"])
